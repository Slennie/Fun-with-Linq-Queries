...
namespace LinqExercises.Controllers
{
    public class CustomersController : ApiController
    {
        ...
        public IHttpActionResult GetAll(string city)
        {
            ...
            var resultSet = _db.Customers.Where(currentCustomer => currentCustomer.City == city);
        ...
        public IHttpActionResult GetAllFromMexicoSwedenGermany()
        {
            ...
            var resultSet = _db.Customers.Where(currentCustomer => currentCustomer.Country == "Mexico" || currentCustomer.Country == "Sweden" || currentCustomer.Country =="Germany" );
        ...
        public IHttpActionResult GetCustomersThatShipWith(string shipperName)
        {
           // throw new NotImplementedException("Write a query to return all customers with orders that shipped using the given shipperName.");
            var resultSet = _db.Customers.Where(currentCustomer => currentCustomer.Orders.Any(currentOrder => currentOrder.Shipper.CompanyName == shipperName));
        ...
        public IHttpActionResult GetCustomersWithoutOrders()
        {
            ...
            var resultSet = _db.Customers.Where(currentCustomer => !currentCustomer.Orders.Any(currentOrder => currentOrder.CustomerID == currentCustomer.CustomerID));
