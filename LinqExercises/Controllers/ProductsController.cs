    ...
    public class ProductsController : ApiController
    {
        ...
        public IHttpActionResult GetDiscontinuedCount()
        {
            ...
            var resultSet = _db.Products
                                .Where(currentProduct => currentProduct.Discontinued == true)
                                .Count();
        ...
        public IHttpActionResult GetProductsInCategory(string categoryName)
        {
            ...
            var resultSet = _db.Products
                    .Where(currentProduct => currentProduct.Category.CategoryName == categoryName);
        ...
        public IHttpActionResult GetStockReport()
        {
            ...
            /* throw new NotImplementedException(@"
             ...
             ");*/
            var newResult = _db.Products
                .Select(currentProduct => new
                {
                    ProductName = currentProduct.ProductName,
                    TotalStockUnits = currentProduct.UnitsInStock + currentProduct.UnitsOnOrder,

                })
                .Where(currentProduct => currentProduct.TotalStockUnits > 100);
