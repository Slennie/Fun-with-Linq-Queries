...
namespace LinqExercises.Controllers
{
    public class ShippersController : ApiController
    {
        ...
        public IHttpActionResult GetFreightReport()
        {
            ...
            //");
            var newResult = _db.Shippers
                .Select(currentShipper => new
                {
                    Shipper = currentShipper.CompanyName,
                    FreightTotals = currentShipper.Orders.Sum(shipperOrder => shipperOrder.Freight)
